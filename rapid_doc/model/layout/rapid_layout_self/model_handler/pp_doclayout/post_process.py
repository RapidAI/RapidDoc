...
class PPPostProcess:
    def __init__(self, labels, conf_thres: Union[float, dict]=0.5, iou_thres=0.5, layout_nms=True, layout_merge_bboxes_mode=None, layout_unclip_ratio=None, scale_size=None):
        self.labels = labels
